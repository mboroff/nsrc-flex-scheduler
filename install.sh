...
bgid=$!
sudo apt-get install -y -qq apache2 mariadb-server php php-mysql php-sqlite3 php-cli libapache2-mod-php > /dev/null
kill $bgid
wait
ProgressBar ${_end} ${_end}
echo ""
...
sudo apt-get install -y -qq php-sqlite3 > /dev/null
